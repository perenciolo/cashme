...
/**
 * Form controller for Income edit forms.
 *
 * @ingroup cashme_incomes
 */
class IncomeForm extends ContentEntityForm {
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    switch ($status) {
      case SAVED_NEW:
        $this->messenger()->addMessage($this->t('Created the %label Income.', [
          '%label' => $entity->label(),
        ]));
        break;

      default:
        $this->messenger()->addMessage($this->t('Saved the %label Income.', [
          '%label' => $entity->label(),
        ]));
    }
    $form_state->setRedirect('entity.income.canonical', ['income' => $entity->id()]);
  }
