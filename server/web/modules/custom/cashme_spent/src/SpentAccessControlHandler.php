...
/**
 * Access controller for the Spent entity.
 *
 * @see \Drupal\cashme_spent\Entity\Spent.
 */
class SpentAccessControlHandler extends EntityAccessControlHandler {

  /**
   * {@inheritdoc}
   */
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\cashme_spent\Entity\SpentInterface $entity */
    ...
    switch ($operation) {
      ...
      case 'view':
        ...
        if (!$entity->isPublished()) {
          ...
          return AccessResult::allowedIfHasPermission($account, 'view unpublished spent entities');
        }
        ...
        return AccessResult::allowedIfHasPermission($account, 'view published spent entities');
      ...
      case 'update':
        ...
        return AccessResult::allowedIfHasPermission($account, 'edit spent entities');
      ...
      case 'delete':
        ...
        return AccessResult::allowedIfHasPermission($account, 'delete spent entities');
    }
  ...
  protected function checkCreateAccess(AccountInterface $account, array $context, $entity_bundle = NULL) {
    return AccessResult::allowedIfHasPermission($account, 'add spent entities');
  }
