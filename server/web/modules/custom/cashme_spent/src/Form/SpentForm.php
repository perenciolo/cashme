...
/**
 * Form controller for Spent edit forms.
 *
 * @ingroup cashme_spent
 */
class SpentForm extends ContentEntityForm {
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    switch ($status) {
      case SAVED_NEW:
        $this->messenger()->addMessage($this->t('Created the %label Spent.', [
          '%label' => $entity->label(),
        ]));
        break;

      default:
        $this->messenger()->addMessage($this->t('Saved the %label Spent.', [
          '%label' => $entity->label(),
        ]));
    }
    $form_state->setRedirect('entity.spent.canonical', ['spent' => $entity->id()]);
  }
